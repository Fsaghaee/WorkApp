...
@section('centercontent')
    <div style="margin: 20px;">
        ...
        $response = file_get_contents('https://api.openweathermap.org/data/2.5/onecall?lat=48.297554&&lon=16.33&dt='.$Tdate.'&units=metric&%20exclude=hourly,daily&appid=ce89196cd42acfa4d84cd561fdb3fde0');
        $response = json_decode($response, true);
